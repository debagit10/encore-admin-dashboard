...
const Delete_Tool: React.FC<DeleteProps> = ({ toolData, refreshTools }) => {
          ...
          <div className="flex flex-col gap-[2rem]">
            ...
            <div className="flex flex-col gap-[1rem] justify-center text-center">
              <Typography fontWeight={400} fontSize={22} color="#00000A">
                Are you sure you want to Delete this A.I tool?
              </Typography>

              <Typography fontWeight={400} fontSize={14} color="#55555C">
                Deleting this tool means all records associated with this tool
